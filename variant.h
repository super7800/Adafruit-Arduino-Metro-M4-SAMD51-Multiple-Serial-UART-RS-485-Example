...
// Serial3
#define PIN_SERIAL3_RX       (58ul)
#define PIN_SERIAL3_TX       (59ul)
#define PAD_SERIAL3_TX       (UART_TX_PAD_0)
#define PAD_SERIAL3_RX       (SERCOM_RX_PAD_1)

// Serial4
#define PIN_SERIAL4_RX       (60ul) // SERCOM0.1
#define PIN_SERIAL4_TX       (55ul) // SERCOM0.0
#define PAD_SERIAL4_TX       (UART_TX_PAD_0)
#define PAD_SERIAL4_RX       (SERCOM_RX_PAD_1)

// Serial5
#define PIN_SERIAL5_RX       (25ul)
#define PIN_SERIAL5_TX       (26ul)
#define PAD_SERIAL5_TX       (UART_TX_PAD_0)
#define PAD_SERIAL5_RX       (SERCOM_RX_PAD_1)

// Serial6
#define PIN_SERIAL6_RX       (22u)
#define PIN_SERIAL6_TX       (23u)
